...
if (!(Test-Endpoint 'http://127.0.0.1:8000/health') -or !(Test-Endpoint 'http://127.0.0.1:3011/new-order') -or !(Test-Endpoint 'http://127.0.0.1:3011/erp') -or !(Test-ImageProcessingReady)) {
...
do {
    if ((Test-Endpoint 'http://127.0.0.1:8000/health') -and (Test-Endpoint 'http://127.0.0.1:3011/new-order') -and (Test-Endpoint 'http://127.0.0.1:3011/erp') -and (Test-ImageProcessingReady)) {
        Start-Process 'http://127.0.0.1:3011/erp'
        exit 0
    }
